...
internal sealed class RecipeBuilder
{
    ...
    private double AmbientTemperature { get; set; }
    ...
    internal RecipeBuilder WithAmbientTemperature(double ambientTemperature)
    {
        var temperature = Guard.Against.NegativeOrZero(ambientTemperature, nameof(AmbientTemperature));
        temperature = Guard.Against.OutOfRange(temperature, nameof(AmbientTemperature), -273.15, 1000.0);
